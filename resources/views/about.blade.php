              ...
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{asset('uploads/'.
                                          $aboutss->image)}}" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">{{$aboutss->name}}</h3>
                  <p class="block-38-subheading">{{$aboutss->position}}</p>
                </div>
