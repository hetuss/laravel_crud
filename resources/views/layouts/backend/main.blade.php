            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                     ...
                     <li class="active">
                        <a href="{{route('admin.socialmedia')}}">Social Media</a>
                    </li>
                    <li class="active">
                    ...
                    <li class="active">
                        <a href="{{route('admin.password')}}">admin</a>
                    </li>
                     <li class="active">
                        <a href="{{route('admin.team')}}">Our Team</a>
                    </li>
                     <li class="active">
                        <a href="{{route('querytable')}}">Client Query</a>
                    </li>
                    <li class="active">
                    ...
                    <!-- <li class="active">
                        <a href="abcd.blade.php"> <i class="menu-icon fa fa-dashboard"></i>form </a>
                    </li> -->
